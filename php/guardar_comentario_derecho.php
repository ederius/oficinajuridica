...
$Segundos= time();
	...
	$sql=mysql_query(" INSERT INTO comentarios_derechos VALUES ('', '".$comentario."' ,'".$id_derecho."', 
...
if(!$sql)
  ...
  {
     $consulta=mysql_query(" SELECT * FROM comentarios_derechos WHERE '".$id_derecho."' = id_derecho") or die(error_reporting());
