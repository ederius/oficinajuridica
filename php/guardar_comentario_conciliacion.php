...
$Segundos= time();
	...
	$sql=mysql_query(" INSERT INTO comentarios_conciliacion VALUES ('', '".$comentario."' ,'".$id_conciliacion."', 
...
if(!$sql)
  ...
  {
     $consulta=mysql_query(" SELECT * FROM comentarios_conciliacion WHERE '".$id_conciliacion."' = id_conciliacion") or die(error_reporting());
