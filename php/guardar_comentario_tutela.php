...
$Segundos= time();
  ...
  $sql=mysql_query(" INSERT INTO comentarios_tutela VALUES ('', '".$comentario."' ,'".$id_tutela."', 
...
if(!$sql)
  ...
  {
     $consulta=mysql_query(" SELECT * FROM comentarios_tutela WHERE '".$id_tutela."' = id_tutela") or die(error_reporting());
