...
$Segundos= time();
  ...
  $sql=mysql_query(" INSERT INTO comentarios_polizas VALUES ('', '".$comentario."' ,'".$id_polizas."', 
...
if(!$sql)
  ...
  {
     $consulta=mysql_query(" SELECT * FROM comentarios_polizas WHERE '".$id_polizas."' = id_poliza") or die(error_reporting());
